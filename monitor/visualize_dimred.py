...
from ..utils.dataloader import DataLoader, SequenceLoader
...
class LatentManifold(Manifold):
    def __init__(self, transformation, model, dataset, preprocessing=None, loader=DataLoader, n_points=None,  metadata=None, layer=-1, *args, **kwargs):
        self.layer = layer
        self.anchors = {}
        ...
        if transformation is not None:
            ...
            dataset.data = preprocessing(dataset.data)
